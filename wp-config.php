...
if ( WP_LOCAL_SERVER || WP_DEV_SERVER ) {
	...
	define( 'W3TC_PRO', true ); // Added by Synthesis (v2.0)
	define( 'DISABLE_WP_CRON', true );
	define( 'WP_POST_REVISIONS', FALSE );
	define( 'WP_MEMORY_LIMIT', '256M' ); // Temporary workaround for memory leak

	define( 'RT_WP_NGINX_HELPER_CACHE_PATH', '/var/lib/nginx/fastcgi_a' ); // Nginx helper plugin by RTCamp - we specify the path where nginx fastcgi cache is stored, so that it can purge
}
