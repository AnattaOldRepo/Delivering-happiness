...
function delivering_happiness_setup() {
	...
	add_theme_support( 'custom-background', apply_filters( 'delivering_happiness_custom_background_args', array(
...
function delivering_happiness_scripts() {
	...
	wp_enqueue_script( 'delivering-happiness-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20120206', true );

	wp_enqueue_script( 'delivering-happiness-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20130115', true );
