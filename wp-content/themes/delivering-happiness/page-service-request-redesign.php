<?php
/*
Template Name: Service Request Form redesign
*/
get_header();
    ...
    <section class="one-column hero">
		<div class="wrapper">
			<div class="copy">
				<h2>
					How can we<br/>
					<em>Make Happy Work<sup>™</sup></em><br/>
					together?
				</h2>
			</div>
		</div>
		...
		<div class="wrapper">
			...
			<div class="col right-col">
				<div class="service-form">
					...
					<iframe src="http://go.deliveringhappiness.com/l/66522/2015-07-30/317n3h" width="100%" height="761" type="text/html" frameborder="0" allowTransparency="true" style="border: 0"></iframe>
				</div>
			</div>
		</div>
	</section>
