...
EOD;
	...
	public static function tooltips($tooltips){
		$salesforce_tooltips = array(
			...
			"salesforce_manual_export" => "<h6>" . __("Manual Export", "gravity-forms-salesforce") . "</h6>" . __("If you don't want all entries sent to Salesforce, but only specific, approved entries, check this box. To send an entry to Salesforce, you go to Entries, choose the entry you would like to send to Salesfroce, and then click the 'Send to Salesforce' button.", "gravity-forms-salesforce"),
		);
...
<script type="text/javascript">
	...
	private static function create($entry, $form, $feed, $api) {
