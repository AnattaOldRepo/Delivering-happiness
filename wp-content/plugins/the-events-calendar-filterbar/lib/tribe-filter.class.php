			...
			switch( $this->type ) {
				...
				?>
					...
					<?php foreach ( $values as $option ):
						...
						// output option to screen
						printf('<li><label><input type="checkbox" value="%s" %s name="%s" %s /><span title="%s">%s</span></label></li>',
							esc_attr( $option['value'] ),
				...
				?>
					...
					<?php foreach ( $values as $option ):
						...
						// output option to screen
						printf('<li><label><input type="radio" value="%s" %s name="%s" %s /><span title="%s">%s</span></label></li>',
							esc_attr( $option['value'] ),
